...
void TestPiece_I::Rotate_Piece_I(){
  PieceTest1 = new Piece_I();
...
void TestPiece_I::setUp(void)
{
	PieceTest1 = new Piece_I();
  BoardTest = new Board();
}
void TestPiece_I::tearDown(void)
{
	delete PieceTest1;
  delete BoardTest;
...
//-----------------------------------------------------------------------------
CPPUNIT_TEST_SUITE_REGISTRATION( TestPiece_I );
