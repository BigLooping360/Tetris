...
/*! \class Piece_Z
 * \brief Représentation d'un Tétrimino en forme de J. Hérite de Piece.
...
class Piece_Z : public Piece{
  ...
  * \brief Vérifie si on peut tourner le Tétrimino en forme de Z d'un cran dans le sens horaire par rapport au Board.
  * \param b est le Board de notre Tetris
  */
  bool isRotateable(Board b);
  /*! \fn void Rotate(Board b)=0
  * \brief Permet la rotation d'un Tétrimino en forme de Z dans le sens horaire par rapport au Board.
  * \param b est le Board de notre Tetris
  */
  void Rotate(Board b);
  /*! \fn Piece_Z()
