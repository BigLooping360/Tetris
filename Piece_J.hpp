...
class Piece_J : public Piece{
  ...
  * \brief Vérifie si on peut tourner le Tétrimino en forme de J d'un cran dans le sens horaire par rapport au Board.
  * \param b est le Board de notre Tetris
  */
  bool isRotateable(Board b);
  /*! \fn void Rotate(Board b)=0
  * \brief Permet la rotation d'un Tétrimino en forme de J dans le sens horaire par rapport au Board.
  * \param b est le Board de notre Tetris
  */
  void Rotate(Board b);
  /*! \fn Piece_J()
